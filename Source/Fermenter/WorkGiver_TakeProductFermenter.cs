...
namespace Fermenter
{
	...
	public class WorkGiver_TakeProductFermenter : WorkGiver_Scanner
	{
		...
		public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
		{
			...
			return compFerment != null && (compFerment.Removing || compFerment.Spoiled || compFerment.Cancelling) && (compFerment != null && (compFerment.Fermented || (compFerment.Cancelling && compFerment.ingredients > 0)) && !t.IsBurning() && !t.IsForbidden(pawn)) && pawn.CanReserveAndReach(t, PathEndMode.Touch, pawn.NormalMaxDanger(), 1, -1, null, forced);
		}

		// Token: 0x06000095 RID: 149 RVA: 0x00004E53 File Offset: 0x00003053
		public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
		{
			return new Job(DefDatabase<JobDef>.GetNamed("TakeProductFermenter", true), t);
		}
	}
}
